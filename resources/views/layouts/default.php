...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-sidebartype="full"
        ...
        <!-- Sidebar Start -->
        <?php include base_path('resources/views/components/aside.php'); ?>
        <!-- End Sidebar Start -->
        ...
        <div class="body-wrapper">
            ...
            <!-- Header Start -->
            <?php include base_path('resources/views/components/header.php'); ?>
            <!-- End Header Start -->

            <!-- Content Start -->
            <div class="container-fluid">
                <?= $content ?? ''; ?> <!-- Dynamic content will go here -->
            </div>
            <!-- End Content Start -->
        </div>
        <!-- End Main wrapper -->
